...
const argv = yargs
  ...
  .example('a11y-audit -c /path/to/config.json', 'Run Test using Provided Config')
  .example('a11y-audit https://mywebsite.com --open', 'Run Test on URL')
  .example(' ', ' ')
  .example('----------------------------------', '------------------------------------------')
  .example('NEED MORE HELP ?', 'https://bit.ly/a11y-audit-help')
  .example('----------------------------------', '------------------------------------------')
  .help()
  .version().argv
